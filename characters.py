...
config = {
    ...
    '旅行者-风': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0.75, '元素充能效率': 0},
    ...
    '早柚': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 1, '元素充能效率': 0.55},
    '砂糖': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 1, '元素充能效率': 0.55},

    # 火
    '托马': {'生命值': 1, '攻击力': 0.5, '防御力': 0, '暴击率': 0.5, '暴击伤害': 0.5, '元素精通': 0.75, '元素充能效率': 0.9},
    ...
    '辛焱': {'生命值': 0, '攻击力': 0.75, '防御力': 0.5, '暴击率': 1, '暴击伤害': 1, '元素精通': 0, '元素充能效率': 0},
    ...
    '坎蒂丝': {'生命值': 1, '攻击力': 0, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0, '元素充能效率': 0.55},
    '妮露': {'生命值': 1, '攻击力': 0, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0.75, '元素充能效率': 0},
    ...
    '莱依拉': {'生命值': 1, '攻击力': 0, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0, '元素充能效率': 0.55},

    # 雷
    '九岐忍': {'生命值': 1, '攻击力': 0, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 1, '元素充能效率': 0},
    '旅行者-雷': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0, '元素充能效率': 0.55},
    '八重神子': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0.75, '元素充能效率': 0},
    '雷电将军': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0, '元素充能效率': 0.9},
    '刻晴': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0.75, '元素充能效率': 0},
    '九条裟罗': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0, '元素充能效率': 0.55},
    '菲谢尔': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0.75, '元素充能效率': 0},
    ...
    '多莉': {'生命值': 1, '攻击力': 0.5, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0, '元素充能效率': 0.55},
    '赛诺': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 1, '元素充能效率': 0},
    
    # 岩
    '旅行者-岩': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0, '元素充能效率': 0},
    ...
    '阿贝多': {'生命值': 0, '攻击力': 0.5, '防御力': 1, '暴击率': 1, '暴击伤害': 1, '元素精通': 0, '元素充能效率': 0},
    ...
    # 草
    '旅行者-草': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0.75, '元素充能效率': 0.75},
    '提纳里': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0.75, '元素充能效率': 0},
    '柯莱': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 0.75, '元素充能效率': 0.55},
    '纳西妲': {'生命值': 0, '攻击力': 0.75, '防御力': 0, '暴击率': 1, '暴击伤害': 1, '元素精通': 1, '元素充能效率': 0},
}