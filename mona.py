...
def update():
    ...
    # 映射表
    set_name_map ={'悠古的磐岩': 'archaicPetra',
    ...
    position_map = {'生之花': 'flower',
                    '死之羽': 'feather',
                    '时之沙': 'sand',
                    '空之杯': 'cup',
                    '理之冠': 'head'}
    main_name_map = {'攻击力': 'attackPercentage',
                     '生命值': 'lifePercentage',
    ...
    normal_name_map = {'攻击力': 'attackStatic',
                       '攻击力百分比': 'attackPercentage',
                       '生命值': 'lifeStatic',
                       '生命值百分比': 'lifePercentage',
                       '防御力': 'defendStatic',
                       '防御力百分比': 'defendPercentage',
                       '元素精通': 'elementalMastery',
                       '元素充能效率': 'recharge',
                       '暴击率': 'critical',
                       '暴击伤害': 'criticalDamage'}
